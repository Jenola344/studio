    ...
    <AuroraBackground>
      ...
      >
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            Building the bridge between<br /> <span className="glowing-text">Developers</span> and <span className="glowing-text">Web3</span><br /> <span className="glowing-text">Ecosystems.</span>
          </motion.h1>
